...
def tail(Args, Adapt):
    ...
    Args.job_name = f"from_scratch/{Adapt.agent_stem}/{buffer_prefix}/ganlr{Adapt.gan_lr}/gandiscrlr{Adapt.gan_disc_lr}/{Args.seed}"


sweep.save("from_scratch_encoder.jsonl")
